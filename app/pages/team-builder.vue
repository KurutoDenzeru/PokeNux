    ...
    <div class="flex-1">
      <div class="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Card class="flex items-center justify-center min-h-[220px] border-2 border-dashed cursor-pointer hover:bg-secondary transition-colors"
            @click="createNewTeam">
          ...
          <!-- Team Cards -->
          <Card
            v-for="team in teamBuilderStore.teams"
            :key="team.id"
            ...
            <div>
              <div class="flex items-start justify-between mb-3">
                <div class="flex-1">
                  ...
                  <p class="text-xs text-muted-foreground">{{ team.members.filter(m => m.pokemonId).length }}/6 Pokémon</p>
                </div>
                <Button
                  size="sm"
                  variant="ghost"
      ...
      <DialogContent class="max-w-4xl! max-h-[90vh] overflow-y-auto">
        ...
        <div class="space-y-4">
          ...
          <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
            <TeamSlot
              v-for="(member, index) in editingTeam?.members"
              :key="index"
          ...
          <div class="flex flex-wrap gap-2">
            <Button
              size="sm"
              variant="outline"
              @click="randomizeTeam(editingTeam?.id || '')"
              class="gap-2"
            >
              <Shuffle class="w-4 h-4" />
              Randomize
            ...
            <Button
              size="sm"
              variant="outline"
              @click="clearTeam(editingTeam?.id || '')"
              class="gap-2"
            >
