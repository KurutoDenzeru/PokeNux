      ...
      <SelectContent>
        <SelectGroup>
          <SelectItem :value="'asc-id'">
            <span class="flex items-center gap-2"><ChevronUp class="size-4"/> Sort Asc</span>
          </SelectItem>
          <SelectItem :value="'desc-id'">
            <span class="flex items-center gap-2"><ChevronDown class="size-4"/> Sort Desc</span>
          </SelectItem>
          <SelectSeparator />
          <SelectItem :value="'az'">
            <span class="flex items-center gap-2"><ArrowUp class="size-4"/> A → Z</span>
          </SelectItem>
          <SelectItem :value="'za'">
            <span class="flex items-center gap-2"><ArrowDown class="size-4"/> Z → A</span>
          </SelectItem>
        </SelectGroup>
      </SelectContent>
    </Select>
