      ...
      <div class="space-y-4">
        <div v-for="stat in stats" :key="stat.name" class="space-y-2">
          <div class="flex items-center justify-between text-sm">
            ...
            <span class="font-bold text-emerald-600 dark:text-emerald-400 w-12 text-right">{{ stat.base }}</span>
        ...
        <div class="pt-4 border-t">
          <div class="flex items-center justify-between font-bold">
            <span>Total</span>
            <span class="text-lg text-emerald-600 dark:text-emerald-400">{{ totalStats }}</span>
          </div>
        </div>
      </div>
    </CardContent>
