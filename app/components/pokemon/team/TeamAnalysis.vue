  ...
  <div class="space-y-6">
    ...
    <div>
      ...
      <div class="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-2">
        <div v-for="type in allTypes" :key="type" :class="[
      ...
      <div class="space-y-3">
        <div>
          ...
          <div class="w-full bg-secondary rounded-full h-3">
            <div class="bg-emerald-500 h-3 rounded-full transition-all"
    ...
    <div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        <div v-for="(member, idx) in props.team.members" :key="idx" v-show="member.pokemonId"
          class="p-3 rounded-lg bg-secondary">
          <p class="font-medium text-sm mb-2 capitalize">{{ member.pokemonName }}</p>
          <div class="flex flex-wrap gap-1">
            <div v-for="type in getMemberTypes(member.pokemonId)" :key="type" :class="getTypeClasses(type)"
      ...
      for (const member of props.team.members) {
        if (member.pokemonId) {
          ...
          data.types.forEach((t: any) => {
            ...
            // Increment coverage for this type
            coverage.value[typeName] = (coverage.value[typeName] || 0) + 1
          })
